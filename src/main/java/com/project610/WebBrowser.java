...
public class WebBrowser extends JFrame {
     ...
     */
    public WebBrowser(String startURL, boolean useOSR, boolean isTransparent, String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
...
//        });
    ...
    public static void main(String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        WebBrowser wb = new WebBrowser("http://www.google.com", useOsr, false, args);
        System.out.println("address: " + wb.address_.getText());

    }

    public String getAddress() {
        return address_.getText();
    }
}
